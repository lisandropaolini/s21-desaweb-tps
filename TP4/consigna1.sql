CREATE DATABASE lisandro_tp4;

USE lisandro_tp4;

CREATE TABLE `pedidos` (
  `id_pedidos` int(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
VALUES 
('clara','clarapaolini@gmail.com','+56985644562','bv colon 436','3','4');
...
INSERT INTO `pedidos`(`nombre`, `email`, `telefono`, `direccion`, `alf_cer`, `alf_arr`) 
VALUES 
('clara','clarapaolini@gmail.com','+56985644562','bv colon 436','6','6');
